...
int main(int argc,char** argv){
    ...
    ifstream ifs1("/Users/jianhangxu/Documents/2Cl/cl_63H2O_npt_bo_300K/out.12.6658/cl.cel");
    ifstream ifs2("/Users/jianhangxu/Documents/2Cl/cl_63H2O_npt_bo_300K/out.12.6658/cl.pos");
    //molecule_manip* water = new water_manip();
    
    for(int i=0;i!=26170;++i){
