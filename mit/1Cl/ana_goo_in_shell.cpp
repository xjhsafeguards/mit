...
int main(int argc,char** argv){
    ...
    { // Print CN
        ...
        double average_CNO=0, average_CNH=0;
        for(int i=0;i< X.size(); i++){
            average_CNO += X[i]*Y[i];
            average_CNH += X[i]*Y2[i];
        }
        ...
        ofs << "#" << setw(19) << "OCl_cutoff:" << setw(20) << OCl_cutoff << setw(20) << "HCl_cutoff: " << setw(20) << HCl_cutoff << endl;
        ofs << "#" << setw(19) << "avg_CNO:" << setw(20) << average_CNO << setw(20) << "avg_CNH: " << setw(20) << average_CNH << endl;
